...
class Subcircuit:
    ...
    def add_input(self, original_name, wire):
        wire._original_name = original_name  # Hacking it up for easy translation to modules
    ...
    def twire(self, x):
        ...
        if s.name in []:  # For debugging: add in the name of a wire you want to check
            real_name = s._original_name if hasattr(s, '_original_name') else "NONE"
            print("Wire %s's real name is %s" % (s.name, real_name))
        return s
